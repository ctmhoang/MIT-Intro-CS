...
# -*- coding: utf-8 -*-
"""
Created on Sat Jul 27 23:12:21 2019
...
#You are also given a function f, that takes
...
# The function will return a tuple of two
...
# the function f to these keys' values -- the value of the common key in d1 is
# the first parameter to the function and the value of the common key in d2 is
# the second parameter to the function. Do not implement f
...
# in d1 whose key appears only in d1 and not in d2
...
# Assume is f-func is defined outside of the code
def dict_interdiff(d1, d2):
    '''
    d1, d2: dicts whose keys and values are integers
    Returns a tuple of dictionaries according to the instructions above
