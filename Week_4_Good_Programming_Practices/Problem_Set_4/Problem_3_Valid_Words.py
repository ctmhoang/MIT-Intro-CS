...
def isValidWord(word, hand, wordList): #Write in one line
    """
...
#    else: 
#        return False
    return bool((word.lower() in wordList) * (0 not in [0 for i in getFrequencyDict(word.lower()) if getFrequencyDict(word.lower())[i] > hand.get(i,0)]))
